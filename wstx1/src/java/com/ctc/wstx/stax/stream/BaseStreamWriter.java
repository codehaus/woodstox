...
/**
 * Base class for specific {@link XMLStreamWriter} implementations.
 * Contains some of utility methods sub-classes use, but does not implement
 * main functionality itself.
 *<p>
 * This class should not be directly referenced from outside package,
 * thus defined as package private
 */
               ...
               OutputConfigFlags
{
    ...
    /**
     * Method needed by {@link com.ctc.wstx.stax.WstxEventWriter}, when it needs/wants to
    ...
    /**
     * Convenience method needed by {@link com.ctc.wstx.stax.WstxEventWriter}, to use when
    ...
    /**
     * Method called by {@link com.ctc.wstx.stax.WstxEventWriter} (instead of the version
    ...
    /**
     * Method called by {@link com.ctc.wstx.stax.WstxEventWriter} (instead of more generic
