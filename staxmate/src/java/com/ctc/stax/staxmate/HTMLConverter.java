...
public final class HTMLConverter
{
        ...
        throws IOException, XMLStreamException
    {
        ...
        SMIterator it = StaxMate.rootElementIterator(sr);
        ...
        throws IOException, XMLStreamException
    {
        ...
        while ((type = headIt.getNext()) != SMIterator.SM_NODE_NONE) {
            if (headIt.getCurrentLocalName().toLowerCase().equals("title")) {
                ...
                out.write("== ");
                String str = StaxMate.collectDescendantText(headIt, true);
        ...
        throws IOException, XMLStreamException
    {
        ...
        if (tag.equals("pre")) {
            ...
            String str = StaxMate.collectDescendantText(it, true);
            if (str.length() > 0) {
                addPara(out, str);
            }
            return true;
        ...
        throws IOException, XMLStreamException
    {
        ...
        out.write(prefix);
        out.write(' ');
        StaxMate.processDescendantText(it, out, true);
        out.write(' ');
        out.write(prefix);
        out.write("\n\n");
    }
        ...
        throws IOException, XMLStreamException
    {
        ...
        while ((type = itemIt.getNext()) != SMIterator.SM_NODE_NONE) {
            if (type == XMLStreamConstants.START_ELEMENT) {
                ...
                addSingleLine(out, StaxMate.collectDescendantText(itemIt, true));
            } else {
        ...
        throws IOException, XMLStreamException
    {
        ...
        while ((type = cellIt.getNext()) != SMIterator.SM_NODE_NONE) {
            if (type == XMLStreamConstants.START_ELEMENT) {
                ...
                // Otherwise, let's just collect and output text:
                addSingleLine(out, StaxMate.collectDescendantText(cellIt, true));
