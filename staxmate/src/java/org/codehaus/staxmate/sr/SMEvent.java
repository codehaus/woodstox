...
public enum SMEvent
{
     ...
     * {@link org.codehaus.staxmate.sr.SMIterator#getText()}
    ...
    /**
     * This method returns true if it would be ok to call
     * {@link org.codehaus.staxmate.sr.SMIterator#getLocalName()}
     * of the iterator object, when it is positioned over this
     * event.
     */
    ...
    /**
     * This method returns true if it would be ok to call
     * {@link org.codehaus.staxmate.sr.SMIterator#getQName()}
     * of the iterator object, when it is positioned over this
     * event.
     */
