...
//} catch (Throwable t) { System.err.println("Error: "+t); }
    ...
    public static void main(String[] args)
    {
        ...
        WordSet set = WordSet.constructSet(words);
        char[] data = set.mData;
...
//outputData(data);
        ...
        //System.out.println("Word '"+key+"' found via array search: "+WordSet.contains(data, keyA, 2, key.length() + 2));
        System.out.println("Word '"+key+"' found via array search: "+set.contains(keyA, 2, key.length() + 2));
        //System.out.println("Word '"+key+"' found via String search: "+WordSet.contains(data, key));
        System.out.println("Word '"+key+"' found via String search: "+set.contains(key));
    }
